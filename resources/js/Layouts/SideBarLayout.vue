...
.light-button {
  background-color: rgb(55 65 81);; /* Green color for light mode */
  color: #fff;
  transition-duration: 0.5s;
}
...
<template>
    ...
    <div id="app" class="flex flex-col min-h-screen">
        <div class="flex flex-1 min-h-screen">
            <div class="bg-gray-700 text-white w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 md:relative md:-translate-x-0 transform -translate-x-full transition duration-200 ease-in-out " :class="width" >
                ...
                <div id="branding" :class="hidden" >
                    <div class="flex items-center justify-center h-14 mb-2 border-gray-800">
                        <img src="/images/NETFLIX.png" alt="NETFLIX" class="w-[150px] h-[90px] mt-4 mb-4">
                    </div>
            ...
            <div class="flex-1 flex flex-col" :class="themeMode === 'dark' ?'dark-button' : 'light'"
            >
                ...
                <!-- Footer -->
                <footer class=" footer footer-center text-center p-4 bg-base-300 text-base-content" :class="themeMode">
                    <aside>
